...
namespace Game.Player
{
    ...
    public class Snake : MonoBehaviour, IObserver
    {
        ...
        internal void Init(int width, int height)
        {
            ...
            for (int i = 1; i < 3; i++)
            {
                Vector3 pos = head.transform.localPosition;// save last Position;
        ...
        //at game start, we need to move the snake in random direction 
        ...
        //when we eat a fruit, receive notification from fruit (fruit collider with snake head will trigger that) 
        public void Notify()//IObserver implementation
        {
        ...
        private void AddPartToBody()
        {
            ...
            part.transform.localPosition = currentTail.lastPosition;
        ...
        public void NotifyWith(Vector3 position1, Vector3 position2) { }//IObserver implementatio
    }
